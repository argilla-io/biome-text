...
@Model.register("bidaf_pair_classifier")
class SequencePairClassifier(AbstractClassifier):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(SequencePairClassifier, self).__init__(vocab, regularizer)
    ...
    def forward(self,  # type: ignore
        ...
        output_dict = {"logits": label_logits, "class_probabilities": label_probs}
    ...
    @classmethod
    def from_params(cls, params: Params, vocab: Vocabulary) -> 'SequencePairClassifier':
