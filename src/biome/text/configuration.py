...
@dataclasses.dataclass
class LTrainerConfiguration:
    """Configures the training of a pipeline

    This is mainly a copy from the
    ...
    num_epochs: Optional[int] = None  # Deprecated, remove in v3.0
    ...
    def __post_init__(self):
        if self.num_epochs is not None:
            _LOGGER.warning(
                "`num_epochs` is deprecated and will be removed in v3.0, please use `max_epochs` instead.",
            )
