...
from typing import Dict, Iterable, Optional, Union, List, Type
...
class _ForwardConfigurationPair:
    def __init__(
        self,
...
class SequenceClassifierDatasetReader(DatasetReader):
    ...
    def _read(self, file_path: str) -> Iterable[Instance]:
        ...
        """
        data_source, forward = get_reader_configuration(file_path, _ForwardConfiguration)
...
class SequencePairClassifierDatasetReader(SequenceClassifierDatasetReader):
    ...
    def _read(self, file_path: str) -> Iterable[Instance]:
        ...
        instance
            An `Instance` that is fed to the model
        """
        data_source, forward = get_reader_configuration(file_path, _ForwardConfigurationPair)
